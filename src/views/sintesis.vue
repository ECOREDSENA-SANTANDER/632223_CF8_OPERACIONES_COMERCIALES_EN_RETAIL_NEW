...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-12.mb-5
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="Diagrama de flujo de los protocolos de cierre de caja, mostrando los pasos desde el cierre de operación hasta el arqueo y entrega del puesto de trabajo.")
      .col-auto
